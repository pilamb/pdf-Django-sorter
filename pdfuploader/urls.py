...
from .views import (ArchiveDelete, ArchiveUpdate, stats, tags, listArchives,
                    uploadpdf, tag_detail)


detail_view = DetailView.as_view(model=Archive)

urlpatterns = [
    url(r'^uploadpdf$', uploadpdf, name='uploadpdf'),
    url(r'^list_uploads$', listArchives, name='list_uploads'),
